...
class ProceduralWeaponSwinger(NodePath):
    ...
    def swing_weapon(self, task):
        ...
        if self.swinging:
            ...
            angle = (
                math.sin(swing_progress * 2 * math.pi) * 60
            )  # Swinging from -60 to +60 degrees
    ...
    def color_cycle(self, task):
        ...
        color_progress = (
            elapsed_time / self.color_cycle_duration
        ...
        self.sword.set_color(
            LVector4(current_color[0], current_color[1], current_color[2], 1)
        )
