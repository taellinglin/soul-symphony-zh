...
class Portal():
    ...
    def __init__(self):
        ...
        self.texture2 = base.loader.loadTexture('/portal/portall02.png')  # Flower texture
        
        # Find the base square part of the portal and apply texture1
        base_part = self.model.find("**/base")  # Replace with actual name of the base node
        if not base_part.isEmpty():
            base_part.setTexture(self.texture1)
        
        # Find the flower object part of the portal and apply texture2
        flower_part = self.model.find("**/flower")  # Replace with actual name of the flower node
