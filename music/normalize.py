...
def normalize_ogg_files():
    ...
    for ogg_file in ogg_files:
        ...
        temp_file = os.path.join(
            output_directory, ogg_file
        )  # Output file path in 'normalized' directory
        ...
        command = [
            ...
            input_file,
            "-ar",
            "96000",  # Set sample rate to 96000 Hz (you can adjust this if needed)
            "-c:a",
            "libvorbis",
            "-q:a",
            "0",  # Quality level (0-10), lower values are better quality
            "-vn",  # No video
